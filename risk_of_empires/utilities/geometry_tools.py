...
def calc_phi_points(p1, p2):
    ...
    OBS 1: Angle spans from 0 to pi for quadrants 1 and 2
    and 0 to -pi for quadrants 4 and 3.
    OBS 2: Q1 is the bottom-right one since display coordinates
    origin are in the top-left corner (instead of typical bottom-left
    from math graphs).
